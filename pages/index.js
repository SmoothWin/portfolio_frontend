...
import {DiMysql, DiMsqlServer, DiPostgresql, DiStreamline, DiReact, DiJavascript, DiJavascript1, DiHtml5, DiCss3Full, DiCss3, DiBootstrap, DiNodejs, DiNodejsSmall, DiDjango} from 'react-icons/di'
  ...
  return (
    <div>
      ...
      <main className="flex flex-col wrapper">
        ...
        <section id='introductionm' className="lg:max-w-[1000px] mx-auto relative w-full mb-2 flex flex-col items-center justify-center text-black">
          ...
          <div className='flex flex-col items-center md:flex-row md:justify-between md:items-start lg:max-w-[1000px] w-[80%] md:min-w-[780px]'>
            ...
            <div className='h-[400px] relative w-[50%] max-w-[390px] min-w-[300px] text-justify' >
              <img className='😀 absolute z-[2] top-[0px] left-[-20px]' width={200} alt={"Project Crypture World"} src={"/images/project1.png"}/>
              <img className='😀 absolute z-[1] top-[150px] left-[160px] blur-[0.1px]' width={200} alt={"Project Code Example"} src={"/images/project2.png"}/>
              <img className='😀 absolute z-[1] top-[40px] left-[180px] blur-[0.2px]' width={170} alt={"Project Github Example"} src={"/images/project3.png"}/>
        ...
        <section className="relative w-full mb-2 flex flex-col items-center justify-center text-black w-full">
            <div className='lg:max-w-[1000px] mx-auto'>
            <h2 className="text-black text-4xl title1 ml-10">Hard Skills</h2>
            {/* introduce hardskills (in progress)*/}
            <div className='grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4 mt-5'>
              <div className='mx-auto w-[250px]'>
                
                  <div className='flex'><h2 className="text-black text-xl title">Backend</h2>&nbsp;&nbsp;<FaLaptopCode className='relative top-[-19px]' size={50}/></div> 
                  ...
                  <div className='flex flex-row justify-around'>
                    ...
                    <svg viewBox="0 0 128 128"  width={63}>
              ...
              <div className='mx-auto w-[250px]'>
                  ...
                  <div className='flex'><h2 className="text-black text-xl title">Databases</h2><DiStreamline className='relative top-[-19px]' size={50}/></div> 
                    
                  <div className='flex flex-row justify-around'>
                    <DiMsqlServer size={70}/>
                    <DiMysql size={70}/>
              ...
              <div className='mx-auto w-[250px] md:col-span-3'>
                
                  <div className='flex'><h2 className="text-black text-xl title">Frontend</h2>&nbsp;&nbsp;<FaLaptop className='relative top-[-19px]' size={50}/></div> 
